...
const api: StartEngineerApi = {
  ...
  getWallpaperBackground: () => ipcRenderer.invoke("wallpaper:get"),
  pickWallpaperBackground: () => ipcRenderer.invoke("wallpaper:pick"),
  removeWallpaperBackground: () => ipcRenderer.invoke("wallpaper:remove"),
